...
export const INIT_CODE_HASH: { [chainId in ChainId]: string } = {
  ...
  [ChainId.MATIC_AMOY_TESTNET]: '0x1b68a89c18551451d63580e66fda7aee3ccf09c7317f32b6747ff18b1173ad09',
...
export const NFT_BID_ADDRESS: { [chainId in ChainId]: string } = {
  ...
  [ChainId.MATIC_AMOY_TESTNET]: '0xf6475c3143574F4d84c627fea3df81036ceeDAC4',
...
export const SPONSOR_ADDRESS: { [chainId in ChainId]: string } = {
  ...
  [ChainId.MATIC_AMOY_TESTNET]: '0xB7196A981De991cdCAEe06Eb7c39c84B5277d234',
...
export const FACTORY_ADDRESS: { [chainId in ChainId]: string } = {
  ...
  [ChainId.MATIC_AMOY_TESTNET]: '0xD21E281493C0c63f6C0B7929D83Aa5E87a83B881',
...
export const ROUTER_ADDRESS: { [chainId in ChainId]: string } = {
  ...
  [ChainId.MATIC_AMOY_TESTNET]: '0x75bCDf4e9900Fac6D8E601624435d9269bAD9051',
...
export const FESW_ADDRESS: { [chainId in ChainId]: string } = {
  ...
  [ChainId.MATIC_AMOY_TESTNET]: '0x31C6ba28f9692564a6ebd516676f2D49ac8C0dba',
...
export const STAKE_FACTORY_ADDRESS: { [chainId in ChainId]: string } = {
  ...
  [ChainId.MATIC_AMOY_TESTNET]: '0x9B592DbCf45F8260657BC9Ac8BB3bCFE2C83d99C',  
...
export const GOVERNANCE_ADDRESS: { [chainId in ChainId]: string } = {
  ...
  [ChainId.MATIC_AMOY_TESTNET]: '0x7725f9A802E1612eC5e5Bf65A73D4318cdA0C4a9',    
...
export const TIMELOCK_ADDRESS: { [chainId in ChainId]: string } = {
  ...
  [ChainId.MATIC_AMOY_TESTNET]: '0xC2078563d1cE2B8fF241A087B37344A7Ea0a07Dd',
