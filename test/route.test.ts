...
describe('Route', () => {
  ...
  const pair_0_1 = new Pair(new TokenAmount(token0, '100'), new TokenAmount(token1, '200'), new TokenAmount(token1, '200'), new TokenAmount(token0, '100'),10100)
  const pair_0_weth = new Pair(new TokenAmount(token0, '100'), new TokenAmount(weth, '100'), new TokenAmount(weth, '100'), new TokenAmount(token0, '100'),10100)
  const pair_1_weth = new Pair(new TokenAmount(token1, '175'), new TokenAmount(weth, '100'), new TokenAmount(weth, '100'), new TokenAmount(token1, '175'),10100)
